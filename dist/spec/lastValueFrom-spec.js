...
describe('lastValueFrom', function () {
    it('should emit the last value as a promise', function () { return __awaiter(void 0, void 0, void 0, function () {
        var finalized, source, result;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    finalized = false;
                    source = rxjs_1.interval(2).pipe(operators_1.take(10), operators_1.finalize(function () { return (finalized = true); }));
    ...
    it('should error for errored observables', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    source = rxjs_1.throwError(new Error('blorp!'));
                    error = null;
                    _a.label = 1;
                case 1:
                    _a.trys.push([1, 3, , 4]);
