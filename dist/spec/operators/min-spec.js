...
describe('min operator', function () {
    it('should min the values of an observable', function () {
        var source = marble_testing_1.hot('--a--b--c--|', { a: 42, b: -1, c: 3 });
        var subs = '^          !';
        var expected = '-----------(x|)';
        marble_testing_1.expectObservable(source.pipe(operators_1.min())).toBe(expected, { x: -1 });
    ...
    it('should be never when source is never', function () {
        ...
        var e1subs = '^';
        var expected = '-';
        marble_testing_1.expectObservable(e1.pipe(operators_1.min())).toBe(expected);
    ...
    it('should min the unique value of an observable', function () {
        ...
        var e1subs = '^     !';
        var expected = '------(w|)';
        marble_testing_1.expectObservable(e1.pipe(operators_1.min())).toBe(expected, { w: 42 });
        marble_testing_1.expectSubscriptions(e1.subscriptions).toBe(e1subs);
    });
    it('should min the values of an ongoing hot observable', function () {
        ...
        var subs = '^          !';
        var expected = '-----------(x|)';
        marble_testing_1.expectObservable(e1.pipe(operators_1.min())).toBe(expected, { x: -1 });
    ...
    it('should work with error', function () {
        ...
        var e1subs = '^        !';
        var expected = '---------#';
        marble_testing_1.expectObservable(e1.pipe(operators_1.min())).toBe(expected, null, 'too bad');
        marble_testing_1.expectSubscriptions(e1.subscriptions).toBe(e1subs);
    });
    ...
    it('should handle a constant predicate on an empty hot observable', function () {
        ...
        marble_testing_1.expectObservable(e1.pipe(operators_1.min(predicate))).toBe(expected);
        marble_testing_1.expectSubscriptions(e1.subscriptions).toBe(e1subs);
    });
    ...
    it('should handle a constant predicate on a simple hot observable', function () {
        ...
        marble_testing_1.expectObservable(e1.pipe(operators_1.min(predicate))).toBe(expected, { w: 1 });
        marble_testing_1.expectSubscriptions(e1.subscriptions).toBe(e1subs);
    });
    it('should allow unsubscribing explicitly and early', function () {
        var e1 = marble_testing_1.hot('-x-^-a-b-c-d-e-f-g-|');
        var unsub = '       !         ';
        var e1subs = '^      !         ';
        var expected = '--------         ';
        var predicate = function () {
        ...
        marble_testing_1.expectObservable(e1.pipe(operators_1.min(predicate)), unsub).toBe(expected);
        marble_testing_1.expectSubscriptions(e1.subscriptions).toBe(e1subs);
    });
    ...
    it('should handle a reverse predicate on observable with many values', function () {
        ...
        marble_testing_1.expectObservable(e1.pipe(operators_1.min(predicate))).toBe(expected, { w: 666 });
        marble_testing_1.expectSubscriptions(e1.subscriptions).toBe(e1subs);
    });
    it('should handle a predicate for string on observable with many values', function () {
        ...
        marble_testing_1.expectObservable(e1.pipe(operators_1.min(predicate))).toBe(expected, { w: 'd' });
        marble_testing_1.expectSubscriptions(e1.subscriptions).toBe(e1subs);
    });
