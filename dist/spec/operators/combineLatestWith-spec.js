...
describe('combineLatestWith', function () {
    var testScheduler;
    beforeEach(function () {
    ...
    it('should combine events from two cold observables', function () {
        testScheduler.run(function (_a) {
            ...
            var result = e1.pipe(operators_1.combineLatestWith(e2), operators_1.map(function (_a) {
                var a = _a[0], b = _a[1];
                return a + b;
            }));
    ...
    it('should work with hot-single and hot-empty', function () {
        testScheduler.run(function (_a) {
            ...
            var e2subs = '   ^---!';
            var expected = ' ----|';
            var result = e2.pipe(operators_1.combineLatestWith(e1), operators_1.map(function (_a) {
                var x = _a[0], y = _a[1];
                return x + y;
            }));
            expectObservable(result).toBe(expected, values);
    ...
    it('should accept array of observables', function () {
        testScheduler.run(function (_a) {
            ...
            var e3subs = '     ^---------!';
            var expected = '   -----wxyz-|';
            var result = e1.pipe(operators_1.combineLatestWith([e2, e3], function (x, y, z) { return x + y + z; }));
    ...
    it('should handle throw after complete left', function () {
        testScheduler.run(function (_a) {
            ...
            var rightSubs = '     ^--------!';
            var expected = '      ---------#';
            var result = left.pipe(operators_1.combineLatestWith(right), operators_1.map(function (_a) {
                var x = _a[0], y = _a[1];
                return x + y;
            }));
    ...
    it('should not break unsubscription chains when unsubscribed explicitly', function () {
        testScheduler.run(function (_a) {
            ...
            var unsub = '      ---------!    ';
            var values = { x: 'bf', y: 'cf', z: 'cg' };
            var result = e1.pipe(operators_1.mergeMap(function (x) { return rxjs_1.of(x); }), operators_1.combineLatestWith(e2), operators_1.map(function (_a) {
                var x = _a[0], y = _a[1];
                return x + y;
    ...
    it('should emit unique array instances with the default projection', function () {
        testScheduler.run(function (_a) {
            ...
            var e2 = hot('  --1--2-|');
            var expected = '-------(c|)';
            var result = e1.pipe(operators_1.combineLatestWith(e2), operators_1.distinct(), operators_1.count());
            expectObservable(result).toBe(expected, { c: 3 });
        });
    });
});
//# sourceMappingURL=combineLatestWith-spec.js.map