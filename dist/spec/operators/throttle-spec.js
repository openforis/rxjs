...
describe('throttle operator', function () {
    ...
    describe('throttle(fn, { leading: true, trailing: true })', function () {
        asDiagram('throttle(fn, { leading: true, trailing: true })')('should immediately emit the first value in each time window', function () {
            var e1 = marble_testing_1.hot('-a-xy-----b--x--cxxx------|');
            var e1subs = '^                         !';
            var e2 = marble_testing_1.cold('----|                     ');
            var e2subs = [' ^   !                     ',
    ...
    describe('throttle(fn, { leading: false, trailing: true })', function () {
        asDiagram('throttle(fn, { leading: false, trailing: true })')('should immediately emit the first value in each time window', function () {
            var e1 = marble_testing_1.hot('-a-xy-----b--x--cxxx------|');
            var e1subs = '^                         !';
            var e2 = marble_testing_1.cold('----|                     ');
            var e2subs = [' ^   !                     ',
