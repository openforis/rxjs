...
describe('mergeMap', function () {
    ...
    type('should support type signatures', function () {
        var o;
        var a1 = o.pipe(operators_1.mergeMap(function (x) { return x.toString(); }));
        var a2 = o.pipe(operators_1.mergeMap(function (x) { return x.toString(); }, 3));
        var a3 = o.pipe(operators_1.mergeMap(function (x) { return x.toString(); }, function (o, i) { return ({ o: o, i: i }); }));
        var a4 = o.pipe(operators_1.mergeMap(function (x) { return x.toString(); }, function (o, i) { return ({ o: o, i: i }); }, 3));
    });
});
