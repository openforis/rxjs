...
describe('Notification', function () {
    ...
    describe('accept', function () {
        it('should accept observer for next Notification', function () {
            ...
            var observer = rxjs_1.Subscriber.create(function (x) {
