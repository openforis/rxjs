...
(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    var NotFoundError = NotFoundErrorImpl;
    ...
    var SequenceError = SequenceErrorImpl;
    ...
    var MergeMapSubscriber = (function (_super) {
        ...
        MergeMapSubscriber.prototype._innerSub = function (ish, value, index) {
            ...
            subscribeToResult(this, ish, undefined, undefined, innerSubscriber);
        };
    ...
    function concat$1() {
        ...
        return function (source) { return source.lift.call(concat.apply(void 0, __spreadArrays([source], observables)), undefined); };
    }
    ...
    function concatWith() {
        ...
        return function (source) { return source.lift.call(concat.apply(void 0, __spreadArrays([source], otherSources)), undefined); };
    }
    ...
    function merge$1() {
        ...
        return function (source) { return source.lift.call(merge.apply(void 0, __spreadArrays([source], observables)), undefined); };
    }
    function mergeWith() {
        var otherSources = [];
        for (var _i = 0; _i < arguments.length; _i++) {
    ...
    function race$1() {
        ...
        return function raceOperatorFunction(source) {
            ...
            return source.lift.call(race.apply(void 0, __spreadArrays([source], observables)), undefined);
        };
    }
    function raceWith() {
        var otherSources = [];
        ...
        return function raceWithOperatorFunction(source) {
            return source.lift.call(race.apply(void 0, __spreadArrays([source], otherSources)), undefined);
        };
    }
    ...
    function zip$1() {
        ...
        return function zipOperatorFunction(source) {
            return source.lift.call(zip.apply(void 0, __spreadArrays([source], observables)), undefined);
        };
    }
    function zipWith() {
        var otherInputs = [];
